...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed=0):
        ...
        # Local Q-Network
        self.local_qnet = QNetwork(state_size, action_size, HIDDEN_LAYERS).to(device)
        # Target Q-Network
        self.target_qnet = QNetwork(state_size, action_size, HIDDEN_LAYERS).to(device)
        # Define Optimizer
    ...
    def learn(self, experiences, gamma):
        ...
        # Update the target network (target_qnet)
        self.soft_update(self.local_qnet, self.target_qnet, TAU)
